            ...
            <div class="col-md-3">
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <a href="{{route('admin.employee.edit',$employee->id)}}" class="btn btn-primary btn-block"><b>Редактировать</b></a>
                        <a href="{{route('admin.rebuke.create', $employee->id)}}" class="btn btn-danger btn-block"><b>Назначить выговор</b></a>
                        <form action="{{route('admin.employee.delete',$employee->id)}}" method="post" class="mt-2">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-dark btn-block"><b>Уволить</b></button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <table class="table">
                    ...
                    @foreach($rebukes as $rebuke)
                        <tr>
                            ...
                            <td>
                                <form action="{{route('admin.rebuke.delete',$rebuke->id)}}" method="post" class="mt-2">
                                    @csrf
                                    @method('delete')
                                    <button type="submit" class="btn btn-dark btn-block"><b>снять</b></button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
